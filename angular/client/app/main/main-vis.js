...
angular.module('angularApp').controller('Visctrl', function ($scope, $window, $timeout, $filter, logFactory, modelSrvc, apiSrvc) {
...
angular.module('angularApp').filter('upper', function($filter) {
